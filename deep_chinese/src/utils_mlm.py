...
def get_args():
    ...
    # data
    parser.add_argument("--train_data", type=str, default="../data/train_mlm.json")
    parser.add_argument("--val_data", type=str, default="../data/val_mlm.json")
    # model
    ...
    parser.add_argument("--save_dir", type=str, default="models/trained_mlm_model.tar")
