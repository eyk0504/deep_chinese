...
if __name__ == "__main__":
    ...
    '''parser.add_argument("--model_path", type=str, \
            default="../models/mlm_model_1", help='model path')'''
    parser.add_argument("--result_path", type=str, \
            default="../models/bertwwm_tuned_test_report.txt", help='output path')
    ...
    model=BertForMaskedLM.from_pretrained("../models/wwm_trained_model")
    model = model.to('cuda')
    model.eval()
